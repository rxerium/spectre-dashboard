  ...
  const scanCategories = [
    ...
    },
    {
      ...
      scans: [
        {
          title: 'Port Scanning',
          description: 'Open port detection',
          path: '/ports',
          icon: Network,
          status: 'warning',
          lastRun: '2 hours ago',
          stats: [
            { value: '7', label: 'Open Ports', color: 'text-amber-warn' },
            { value: '3', label: 'Services', color: 'text-cyan-glow' },
            { value: '0', label: 'Critical', color: 'text-green-open' },
          ],
        },
        {
        ...
        {
          title: 'IP Reputation',
          description: 'IP abuse database checks',
          path: '/ip-reputation',
          icon: Search,
          status: 'success',
          lastRun: '45 min ago',
